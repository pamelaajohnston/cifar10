...
IMAGE_SIZE = qpNet_input.IMAGE_SIZE
NUM_CLASSES = qpNet_input.NUM_CLASSES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = qpNet_input.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = qpNet_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL


# Constants describing the training process.
MOVING_AVERAGE_DECAY = 0.9999     # The decay to use for the moving average.
#NUM_EPOCHS_PER_DECAY = 350.0      # Epochs after which learning rate decays.
NUM_EPOCHS_PER_DECAY = 1750.0      # Epochs after which learning rate decays.
...
def inputs(eval_data):
  ...
  images, labels = qpNet_input.inputs(eval_data=eval_data,
                                        data_dir=data_dir,
